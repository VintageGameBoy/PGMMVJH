...
rem ------------------------------------------------
rem Build
rem %DEVENV_EXE% %PLAYER_ROOT%\player.sln /t:Clean /p:Configuration=Release /p:Platform=Win32
...
copy /Y %PLAYER_ROOT%\%BUILD_OUTPUT_DIR%\steam_appid.txt %PLAYER_OUTPUT%\
...
rem %DEVENV_EXE% %PLAYER_ROOT%\player.sln /t:Clean /p:Configuration=Runtime /p:Platform=Win32
...
copy /y game.tmp game.rc
rem %DEVENV_EXE% %PLAYER_ROOT%\player.sln /t:Clean /p:Configuration=DebugMenuRuntime /p:Platform=Win32
